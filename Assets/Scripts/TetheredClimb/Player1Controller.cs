...
public class Player1Controller : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        {
            AudioManager.I.PlaySFX(AudioManager.I.jumpSound, 0.8f);
        ...
        if (Input.GetKey(KeyCode.L) && (isGrounded || otherIsBelow))
        {
        ...
        if (Input.GetKey(KeyCode.S) && Input.GetKeyDown(KeyCode.W))
